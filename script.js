...
[3,'Li','Litio',6.941,'metal alcalino',2,1],[4,'Be','Berilio',9.012,'alcalinotérreo',2,2],
[5,'B','Boro',10.81,'metaloide',2,13],[6,'C','Carbono',12.01,'no metal',2,14],
[7,'N','Nitrógeno',14.01,'no metal',2,15],[8,'O','Oxígeno',16,'no metal',2,16],
[9,'F','Flúor',19,'halógeno',2,17],[10,'Ne','Neón',20.18,'gas noble',2,18],
[11,'Na','Sodio',22.99,'metal alcalino',3,1],[12,'Mg','Magnesio',24.31,'alcalinotérreo',3,2],
[13,'Al','Aluminio',26.98,'post-transición',3,13],[14,'Si','Silicio',28.09,'metaloide',3,14],
[15,'P','Fósforo',30.97,'no metal',3,15],[16,'S','Azufre',32.07,'no metal',3,16],
[17,'Cl','Cloro',35.45,'halógeno',3,17],[18,'Ar','Argón',39.95,'gas noble',3,18],
[19,'K','Potasio',39.1,'metal alcalino',4,1],[20,'Ca','Calcio',40.08,'alcalinotérreo',4,2],
[21,'Sc','Escandio',44.96,'transición',4,3],[22,'Ti','Titanio',47.87,'transición',4,4],
[23,'V','Vanadio',50.94,'transición',4,5],[24,'Cr','Cromo',52,'transición',4,6],
[25,'Mn','Manganeso',54.94,'transición',4,7],[26,'Fe','Hierro',55.85,'transición',4,8],
[27,'Co','Cobalto',58.93,'transición',4,9],[28,'Ni','Níquel',58.69,'transición',4,10],
[29,'Cu','Cobre',63.55,'transición',4,11],[30,'Zn','Zinc',65.38,'transición',4,12],
[31,'Ga','Galio',69.72,'post-transición',4,13],[32,'Ge','Germanio',72.63,'metaloide',4,14],
[33,'As','Arsénico',74.92,'metaloide',4,15],[34,'Se','Selenio',78.97,'no metal',4,16],
[35,'Br','Bromo',79.9,'halógeno',4,17],[36,'Kr','Kriptón',83.8,'gas noble',4,18],
[37,'Rb','Rubidio',85.47,'metal alcalino',5,1],[38,'Sr','Estroncio',87.62,'alcalinotérreo',5,2],
[39,'Y','Itrio',88.91,'transición',5,3],[40,'Zr','Circonio',91.22,'transición',5,4],
[41,'Nb','Niobio',92.91,'transición',5,5],[42,'Mo','Molibdeno',95.95,'transición',5,6],
[43,'Tc','Tecnecio',98,'transición',5,7],[44,'Ru','Rutenio',101.1,'transición',5,8],
[45,'Rh','Rodio',102.9,'transición',5,9],[46,'Pd','Paladio',106.4,'transición',5,10],
[47,'Ag','Plata',107.9,'transición',5,11],[48,'Cd','Cadmio',112.4,'transición',5,12],
[49,'In','Indio',114.8,'post-transición',5,13],[50,'Sn','Estaño',118.7,'post-transición',5,14],
[51,'Sb','Antimonio',121.8,'metaloide',5,15],[52,'Te','Telurio',127.6,'metaloide',5,16],
[53,'I','Yodo',126.9,'halógeno',5,17],[54,'Xe','Xenón',131.3,'gas noble',5,18],
[55,'Cs','Cesio',132.9,'metal alcalino',6,1],[56,'Ba','Bario',137.3,'alcalinotérreo',6,2],
[72,'Hf','Hafnio',178.5,'transición',6,4],[73,'Ta','Tantalio',180.9,'transición',6,5],
[74,'W','Wolframio',183.8,'transición',6,6],[75,'Re','Renio',186.2,'transición',6,7],
[76,'Os','Osmio',190.2,'transición',6,8],[77,'Ir','Iridio',192.2,'transición',6,9],
[78,'Pt','Platino',195.1,'transición',6,10],[79,'Au','Oro',197,'transición',6,11],
[80,'Hg','Mercurio',200.6,'transición',6,12],[81,'Tl','Talio',204.4,'post-transición',6,13],
[82,'Pb','Plomo',207.2,'post-transición',6,14],[83,'Bi','Bismuto',209,'post-transición',6,15],
[84,'Po','Polonio',209,'post-transición',6,16],[85,'At','Astato',210,'halógeno',6,17],
[86,'Rn','Radón',222,'gas noble',6,18],
[87,'Fr','Francio',223,'metal alcalino',7,1],[88,'Ra','Radio',226,'alcalinotérreo',7,2],
[104,'Rf','Rutherfordio',267,'transición',7,4],[105,'Db','Dubnio',268,'transición',7,5],
[106,'Sg','Seaborgio',269,'transición',7,6],[107,'Bh','Bohrio',270,'transición',7,7],
[108,'Hs','Hassio',277,'transición',7,8],[109,'Mt','Meitnerio',278,'desconocido',7,9],
[110,'Ds','Darmstadtio',281,'desconocido',7,10],[111,'Rg','Roentgenio',282,'desconocido',7,11],
[112,'Cn','Copernicio',285,'transición',7,12],[113,'Nh','Nihonio',286,'desconocido',7,13],
[114,'Fl','Flerovio',289,'desconocido',7,14],[115,'Mc','Moscovio',290,'desconocido',7,15],
[116,'Lv','Livermorio',293,'desconocido',7,16],[117,'Ts','Tenesino',294,'desconocido',7,17],
[118,'Og','Oganesón',294,'desconocido',7,18],
[57,'La','Lantano',138.9,'lantánido',9,3],[58,'Ce','Cerio',140.1,'lantánido',9,4],
[59,'Pr','Praseodimio',140.9,'lantánido',9,5],[60,'Nd','Neodimio',144.2,'lantánido',9,6],
[61,'Pm','Prometio',145,'lantánido',9,7],[62,'Sm','Samario',150.4,'lantánido',9,8],
[63,'Eu','Europio',152,'lantánido',9,9],[64,'Gd','Gadolinio',157.3,'lantánido',9,10],
[65,'Tb','Terbio',158.9,'lantánido',9,11],[66,'Dy','Disprosio',162.5,'lantánido',9,12],
[67,'Ho','Holmio',164.9,'lantánido',9,13],[68,'Er','Erbio',167.3,'lantánido',9,14],
[69,'Tm','Tulio',168.9,'lantánido',9,15],[70,'Yb','Iterbio',173,'lantánido',9,16],
[71,'Lu','Lutecio',175,'lantánido',9,17],
[89,'Ac','Actinio',227,'actínido',10,3],[90,'Th','Torio',232,'actínido',10,4],
[91,'Pa','Protactinio',231,'actínido',10,5],[92,'U','Uranio',238,'actínido',10,6],
[93,'Np','Neptunio',237,'actínido',10,7],[94,'Pu','Plutonio',244,'actínido',10,8],
[95,'Am','Americio',243,'actínido',10,9],[96,'Cm','Curio',247,'actínido',10,10],
[97,'Bk','Berkelio',247,'actínido',10,11],[98,'Cf','Californio',251,'actínido',10,12],
[99,'Es','Einstenio',252,'actínido',10,13],[100,'Fm','Fermio',257,'actínido',10,14],
[101,'Md','Mendelevio',258,'actínido',10,15],[102,'No','Nobelio',259,'actínido',10,16],
[103,'Lr','Lawrencio',266,'actínido',10,17]
];
...
const coloresEstado={
'Gas':'#90CAF9','Líquido':'#4DD0E1','Sólido':'#A5D6A7','Desconocido':'#B0BEC5'
};
...
const p=maximo===minimo?0:(valor-minimo)/(maximo-minimo);
const rojo=Math.floor(52+200*p);
const azul=Math.floor(220-160*p);
...
item.innerHTML=`<span class="legend-color" style="background:${color}"></span><span>${cat.charAt(0).toUpperCase()+cat.slice(1)}</span>`;
...
let color;
if(modo==='Escala: masa')color=colorEscala(masa,Math.min(...masas),Math.max(...masas));
else if(modo==='Escala: número atómico')color=colorEscala(z,Math.min(...numeros),Math.max(...numeros));
else if(modo==='Estado físico')color=coloresEstado[estadoFisico(sym)];
else color=colores[cat]||'#607D8B';
...
info.textContent=comparisonActive?'Selecciona dos elementos para compararlos.':'Comparación cancelada.';
}

function seleccionarElemento(node){
if(selectedElement&&selectedElement!==node)selectedElement.classList.remove('selected');
...
}else info.textContent='Selecciona un segundo elemento para compararlo.';
}else mostrarDetalles(obtenerElemento(node));
}
...
ocultarPreview();
document.getElementById('modal-content').innerHTML=`<div class="detail-symbol" style="color:${color}">${sym}</div><div class="detail-name">${nombre}</div><div class="detail-text">Número atómico: ${z}<br>Masa atómica: ${masa} u<br>Categoría: ${cat.charAt(0).toUpperCase()+cat.slice(1)}<br>Período: ${fila} | Grupo: ${col}<br>Estado físico: ${estado}<br><br>${caracteristica}</div><button class="detail-close-button" id="detail-close-button" style="background:${color}">Cerrar</button>`;
...
const encontrado=elementos.find(el=>String(el[0]).includes(termino)||el[1].toLowerCase().includes(termino)||el[2].toLowerCase().includes(termino));
if(encontrado){
const node=elementNodes.get(encontrado[0]);
seleccionarElemento(node);
node.scrollIntoView({behavior:'smooth',block:'center',inline:'center'});
}else info.textContent='No se encontró ningún elemento con esa búsqueda.';
}
...
const encontrados=elementos.filter(el=>String(el[0]).includes(termino)||el[1].toLowerCase().includes(termino)||el[2].toLowerCase().includes(termino)).slice(0,6);
...
actualizarEstilos();
info.textContent=filterCategory?`Filtro activo: ${categoria.charAt(0).toUpperCase()+categoria.slice(1)}.`:'Filtro eliminado.';
}

function mostrarPreview(node,event){
const[z,sym,nombre,masa,cat]=obtenerElemento(node);
const color=colores[cat]||'#607D8B';
preview.innerHTML=`<div class="preview-symbol" style="color:${color}">${sym}</div><div class="preview-text">${nombre}<br>N.º atómico: ${z} | ${masa} u</div>`;
